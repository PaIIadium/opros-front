    ...
    if (req.readyState == 4) {
      ...
      //  console.log("hiiiiiii", json)
        ...
        updateNumbers(Math.round(json["Чи варто, на вашу думку, подовжувати контракт цьому викладачу"] * 10) / 10,
          ...
          100 - Math.round(json['Викладач систематично дозволяє здати на гарну оцінку завдання/контрольні роботи студентам, які погано володіють матеріалом'] * 10) / 10,
          json['Всього опитано'],
          json['Проведення занять на дистанційному навчанні'].toFixed(1),
