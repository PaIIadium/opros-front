...
function updateNumbers(contract, rso, cheating, respondents, dist1, dist2, dist3) {
  ...
  const distEl3 = document.getElementById('dist3');
  distEl3.innerHTML = dist3;
  ...
  distEl3.style.color = `rgb(${colorDist3[0]}, ${colorDist3[1]}, ${colorDist3[2]})`;
