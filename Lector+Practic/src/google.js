...
const radial = [
  ...
  'Організація часу на практичних заняттях',
  'Актуальність лекційного матеріалу',
  'Коректність викладача',
  'Своєчасність та достатність інформування '
]
const dist_quest = ['Проведення лекцій на дистанційному навчанні',
